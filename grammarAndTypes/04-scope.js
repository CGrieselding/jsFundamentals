/*
    ...
    Different kinds of scopes:
        - Global Scope: variables that are defined outside of a function.  Functions can have acess to variables that are within the global scope.
        ...
        - Local Scope: variables that are defined within a function. Within Indiana, there are aspects that we can focus on that our Global aspect doesn't consider unless we make it available.  
...
if(true){
    let scope = 'Indiana'
    // console.log(scope);    Answer: Indiana marks the local scope - this is because we redefined scope (to Indiana) in this "if" statement
